<nav x-data="{ navOpen: false }" class="bg-white border-b border-gray-100"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-32">
            <div class="flex">
                <!-- Logo -->
                <div class="shrink-0 flex items-center ml-0">
                    <a href="{{ route('dashboard') }}">
                        <x-application-logo class="h-16 w-auto fill-current text-gray-800 ml-[-10]" />
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <!-- This button uses the dropdown’s own Alpine state -->
                        <button class="inline-flex items-center px-3 py-2 text-sm leading-4
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                <button @click="navOpen = ! navOpen"
                    ...
                    <svg class="h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24">
                        <!-- “Menu” icon -->
                        <path :class="{'hidden': navOpen, 'inline-flex': ! navOpen}"
                              class="inline-flex"
    ...
    <div :class="{'block': navOpen, 'hidden': ! navOpen}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- Add more mobile nav links here if desired -->
        </div>
