...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-gray-100">
        ...
        {{-- <div class="flex items-center justify-end bg-white h-16 px-4 shadow">
            ...
            <!--<div class="absolute top-0 right-0 w-[1200px] h-20 flex justify-end items-center px-6 mr-0">-->
            <!--    <img src="{{ asset('/icons/topS5.png') }}" alt="Top Right Image" class="absolute top-0 right-0 h-auto w-auto mr-0">-->
            <!--</div>-->
            <div class="min-h-screen flex "
            style="background-image: url('/icons/cit.png'); background-repeat: repeat; background-size: auto; background-position: center; min-height: 100vh;"
            >
            {{-- bg-gray-800 --}}
            <!-- Sidebar -->
            <aside class="bg-white shadow-md min-h-screen transition-all duration-300"
                :class="isOpen ? 'w-1/7' : 'w-20'" style="background-color: rgb(0, 0, 0);">
                ...
                <ul class="space-y-4 mt-4">
                    @if (Auth::user()->usertype === 'admin')
                        <li class="mt-5 mx-5">
                            <a href="/booking/overview"
                                class="flex items-center text-white hover:text-gray-900 px-4 py-2">
                                <i class="fas fa-user-edit mr-2"></i>
                                <span x-show="isOpen" x-transition>Overview</span>
                            </a>
                        </li>
                        <li class="mt-5 mx-5">
                            <a href="/billing" class="flex items-center text-white hover:text-gray-900 px-4 py-2">
                                <i class="fas fa-user-edit mr-2"></i>
                        ...
                        <li class="mt-5 mx-5">
                            <a href="/movie" class="flex items-center text-white hover:text-gray-900 px-4 py-2">
                                <i class="fas fa-user-edit mr-2"></i>
                                <span x-show="isOpen" x-transition>Movie</span>
                            </a>
                        </li>
                        <li class="mt-5 mx-5">
                            <a href="/show" class="flex items-center text-white hover:text-gray-900 px-4 py-2">
                                <i class="fas fa-user-edit mr-2"></i>
                                <span x-show="isOpen" x-transition>Show</span>
                            </a>
                        </li>
                        <li class="mt-5 mx-5">
                            <a href="/price" class="flex items-center text-white hover:text-gray-900 px-4 py-2">
                                <i class="fas fa-user-edit mr-2"></i>
                                <span x-show="isOpen" x-transition>Price</span>
                            </a>
                        </li>
                        <li class="mt-5 mx-5">
                            <a href="/booking/create/clone"
                                class="flex items-center text-white hover:text-gray-900 px-4 py-2">
                                <i class="fas fa-user mr-2"></i>
                    ...
                    @elseif(Auth::user()->usertype === 'super_admin')
                        <li>
                            <a href="" class="flex items-center text-white hover:text-gray-900 px-4 py-2">
            ...
            <!-- Main Content -->
            <div class="p-6 transition-all duration-300 " :class="isOpen ? 'w-6/7' : 'flex-1'"
